...
<?php
    if ($_SESSION['role'] == "9") {
        ...
        $rPaci = $db->prepare("
            ...
            , lab_aspira.fec
            , count( case when lab_aspira_dias.d1est = 'ATR' then true end ) atresico
            from hc_reprod
            ...
            inner join lab_aspira_dias on lab_aspira_dias.pro = lab_aspira.pro and lab_aspira_dias.estado is true and lab_aspira_dias.d1est = 'ATR'$between
