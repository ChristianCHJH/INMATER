...
<html>
   ...
   include 'seguridad_login.php'
    ...
    <body>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Historia Clínica</a></li>
                    <li class="breadcrumb-item"><a href="#">Reproducción Asistida</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Mantenimiento Extras</li>
                </ol>
            </nav>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body collapse show mx-auto" id="collapseExample">
                        <table width="100%" class="table table-responsive table-bordered align-middle" data-filter="true" data-input="#filtro">
                            ...
                            <tbody>
                            <?php
                                $consulta = $db->prepare("select id, nombre from man_extras_medico where estado = 1 order by id");
                                $consulta->execute();
                                $i=1;
                                while ($item = $consulta->fetch(PDO::FETCH_ASSOC))
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="man_extras_medico_edit.php?id='.$item["id"].'"><img src="_libraries/open-iconic/svg/pencil.svg" height="18" width="18" alt="icon name"></a>
        ...
        <script src="js/man_extras_medico.js?v=18.11.7"></script>
    </body>
</html>