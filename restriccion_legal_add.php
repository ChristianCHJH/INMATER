...
<html>
    <head>
        ...
        if (isset($_POST['dni']) && !empty($_POST['dni']) && isset($_POST['agregar'])) {
            update_legal_01(0, $_POST['dni'], $_POST['finforme'], $_FILES['informe'], $_POST['tipoinforme'], $_POST['obs'], $login);
                ...
                <div class="ui-grid-b">
                    <div class="ui-block-a">
                        <div class="ui-bar" data-role="fieldcontain">
                            ...
                            <input class="form-control" name="finforme" type="date" id="finforme" data-mini="true" required>
                        </div>
                    </div>
                    ...
                    <div class="ui-block-c">
                        <div class="ui-bar" data-role="fieldcontain">
                            ...
                            <select name='tipoinforme' class="form-control" data-mini="true" required>
                ...
                <div class="row pb-2">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="input-group">
                            ...
                            <textarea class="form-control" name="obs" id="obs" data-mini="true"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row pb-2">
                    <div class="col-12 col-sm-12 col-md-12 text-center">
                        <input type="Submit" class="ui-btn ui-btn-inline ui-mini" name="agregar" value="Agregar" data-mini="true"/>
                    </div>
                </div>
            </form>
        </div>
