    ...
    <div class='container'>
        ...
        if ($_SESSION['role'] == 2) {
            ...
            $rRec = $db->prepare("
                ...
                , lab_aspira.fec, hc_paciente.tip, hc_paciente.dni,lab_andro_cap.mue,lab_aspira_t.beta
            ...
            <table class='table table-responsive table-bordered align-middle header-fixed' id='repo_model_01'>
                <thead class='thead-dark'>
                    <tr>
                        ...
                        <th>Cytogenic Study</th>
                        <th>Cytogenic Study Response</th>
