...
$rPaci = $db->prepare("
    ...
    inner join lab_aspira on lab_aspira.rep = hc_reprod.id and lab_aspira.estado is true and lab_aspira.f_fin is not null and lab_aspira.tip = 'R'$between
    left join hc_pareja on hc_pareja.p_dni = hc_reprod.p_dni
    where hc_reprod.estado = true and hc_reprod.cancela=0 and not (hc_reprod.des_don is not null and hc_reprod.des_dia >= 1) and hc_reprod.des_dia = 0
