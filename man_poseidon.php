...
<html>
   ...
   include 'seguridad_login.php'
    ...
    <body>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Mantenimiento Poseidon</li>
                </ol>
            </nav>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body collapse show mx-auto" id="collapseExample">
                        <table width="100%" class="table table-responsive table-bordered align-middle" data-filter="true" data-input="#filtro">
                            ...
                            <tbody>
                            <?php
                                $consulta = $db->prepare("select id, nombre from man_poseidon where estado = 1 order by id");
                                $consulta->execute();
                                $i=1;
                                while ($item = $consulta->fetch(PDO::FETCH_ASSOC))
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="man_poseidon_edit.php?id='.$item["id"].'"><img src="_libraries/open-iconic/svg/pencil.svg" height="18" width="18" alt="icon name"></a>
        ...
        <script src="js/man_poseidon.js?v=18.11.7"></script>
    </body>
</html>