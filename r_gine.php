            ...
            <div class="ui-content" role="main">
                <form action="" method="post" data-ajax="false" id="form1">
                    ...
                    <table style="margin: 0 auto;" width="100%">
                        <tr>
                            <td width="88%" align="center" valign="top">Médicos
                    ...
                    if (isset($_POST['reporte']) && isset($_POST['numUser']) && $_POST['reporte'] <> "" && $_POST['numUser'] > 0) {
                        ...
                        for ($i = 1; $i <= $_POST['numUser']; $i++) {
                            if (isset($_POST['u'.$i]) && !empty($_POST['u'.$i])) {
                                $medico .= "hc_gineco.med='".$_POST['u'.$i]."' OR ";
                            }
                        }
                        ...
                        $rPaci = $db->prepare("
                        SELECT
                        ape, nom, hc_gineco.dni, hc_gineco.fec, hc_gineco.med
                        FROM hc_paciente, hc_gineco
                        WHERE hc_paciente.dni=hc_gineco.dni ".$medico.$rango."
