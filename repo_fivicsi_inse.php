...
<?php
    if ($_SESSION['role'] == "9") {
        ...
        $rPaci = $db->prepare("
            ...
            , lab_aspira.fec
            , count( case when lab_aspira_dias.d1est = 'ATR' then true end ) atresico, count( case when lab_aspira_dias.d1est = 'CT' then true end ) citolizado
            from hc_reprod
