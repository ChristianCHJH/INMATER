...
$rPaci = $db->prepare("
    ...
    inner join lab_aspira_t on lab_aspira_t.pro=lab_aspira.pro and lab_aspira_t.beta=3 and lab_aspira_t.estado is true
    ...
    where hc_reprod.estado = true and hc_reprod.des_don is null and hc_reprod.des_dia >= 1 $busqueda
