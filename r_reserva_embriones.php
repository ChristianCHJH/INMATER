...
<body>
    ...
    inner join lab_aspira_dias c on c.pro=b.pro and c.des=0 and c.estado is true
    and (c.d6f_cic='C' or d5f_cic='C' or c.d4f_cic='C' or c.d3f_cic='C' or c.d2f_cic='C')
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Reserva de Embriones</li>
            </ol>
        </nav>
                ...
                <table class="table table-responsive table-bordered align-middle table-stripe" id="myTable">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th width="10%" class="text-center align-middle">N° Ovo</th>
                            <th width="10%" class="text-center align-middle">Médico</th>
                            <th width="25%" class="text-center align-middle">Paciente</th>
                            <th width="25%" class="text-center align-middle">Reservado a:</th>
                        ...
                        while ($paci = $rPaci->fetch(PDO::FETCH_ASSOC)) { ?>
                            <tr>
                                <?php
                                    ...
                                    <td width="10%" class="text-center">'.$paci['ovo'].'</td>
                                    <td width="10%" class="text-center">'.$paci['med'].'</td>
                                    <td width="25%"><small>'.mb_strtoupper($paci['ape']).' '.mb_strtoupper($paci['nom']).'</small></td>
                                    <td width="25%"><small>'.mb_strtoupper($paci['transferido_ape']).' '.mb_strtoupper($paci['transferido_nom']).'</small></td>
