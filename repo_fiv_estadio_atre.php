...
<?php
    if ($_SESSION['role'] == "9") {
        ...
        $rPaci = $db->prepare("
            ...
            inner join lab_aspira_dias on lab_aspira_dias.pro = lab_aspira.pro and lab_aspira_dias.estado is true and (lab_aspira_dias.d0est = 'ATR' or lab_aspira_dias.d1est = 'ATR')$between
            ...
            , lab_aspira.tip, hc_reprod.p_cic, hc_reprod.p_fiv, hc_reprod.p_icsi, hc_reprod.p_od, hc_reprod.p_don, hc_reprod.p_cri, hc_reprod.p_iiu
            , lab_aspira.fec
            having count( case when (lab_aspira_dias.d0est = 'ATR' or lab_aspira_dias.d1est = 'ATR') then true end ) >= 1
        ...
        <div class="ui-content" role="main" id="imprime">
            ...
            <div class="scroll_h">
                <table style="border: 1px solid;" cellpadding="5">
                    <tbody>
                    <?php
                        print '<tr><td>Embriones Atrésico</td><td>'.$atresico.'</td></tr>';
                    ?>
                        <tr>
