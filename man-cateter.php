...
<?php
   include 'seguridad_login.php';
	...
	<title>Clínica Inmater | Mantenimiento Cateter</title>
...
<body>
	<div class="box container">
				...
				<div class="card-body collapse show">
					<form id="form-confirm-add">
						<div class="row pb-2">
							...
							<div class="col-12 col-sm-12 col-md-3 col-lg-3 input-group-sm">
								<input type="submit" form="form-confirm-add" class="btn btn-sm btn-danger" name="agregar" value="Agregar"/>
							</div>
						</div>
					</form>
				</div>
		...
		<div class="card row content">
			...
			<h5 class="card-header"><small><b>Mantenimiento de Cateter</b></small></h5>
			<div class="card-body">
	...
	<script src="js/man-cateter.js?v=1"></script>
</body>
</html>
