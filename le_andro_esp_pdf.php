<?php
	...
	//firma embriologo
	$consulta = $db->prepare("SELECT id,nom FROM lab_user WHERE id=?");
		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td class="borde" align="center">'.$pop['movi_mprogresivo_no_lineal_cantidad'].'&nbsp;&nbsp;&nbsp;('.(number_format($pop['movi_mprogresivo_no_lineal_cantidad']*100/($pop['movi_mprogresivo_no_lineal_cantidad']+$pop['movi_mprogresivo_no_lineal_cantidad']+$pop['movi_mnoprogresivo_cantidad']+$pop['movi_nmoviles_cantidad']), 2)).' %)</td>
					<td class="borde" colspan="2" align="center"></td>
				</tr>
