    ...
    <div class='container'>
        ...
        if ($_SESSION['role'] == 2) {
            ...
            $rRec = $db->prepare("
                ...
                , lab_aspira.fec, hc_paciente.fnac, hc_paciente.tip, hc_paciente.dni
            ...
            <table class='table table-responsive table-bordered align-middle header-fixed' id='repo_model_01'>
                <thead class='thead-dark'>
                    <tr>
						...
						<th>Weight (kg)</th>
						<th>Height (cm)</th>
						<th>Source of eggs</th>
						<th>Age of Donor</th>
						<th>Lutheal phase supplementation route</th>
						<th>Outcome</th>
						<th>Outcome Type</th>
						<th>Date of oocyte pick up</th>
						<th>Number of oocyted donated</th>
						<th>Type of insemination</th>
						<th>Inseminated ovocyte</th>
						<th>Sperm source</th>
						<th>Sperm source state</th>
						<th>Number fertilized oocytes</th>
						<th>Assisted Hatching</th>
						<th>Preimplantational Genetic Diagnosis</th>
						<th>Nº of biopsed</th>
						<th>Nº of normal</th>
						<th>Number of embryo transfer </th>
						<th>Stage of embryo transfer </th>
						<th>First Ultrasound scan date - optional</th>
						<th>Number of gestational sac in first ultrasound</th>
						<th>Second Ultrasound scan date - optional</th>
						<th>Number of gestational sac in second ultrasound</th>
						<th>Number of newborns</th>
						<th>Gestational age at delivery</th>
						<th>Number of cryopreserved embryos</th>
						<th>Stage of embryo development at freezing</th>
						<th>Baby1 - Viability</th>
						<th>Baby1 - Weight</th>
						<th>Baby1 - Congenital abormality</th>
						<th>Baby1 - Citogenetic study</th>
						<th>Baby2 - Viability</th>
						<th>Baby2 - Weight</th>
						<th>Baby2 - Congenital abormality</th>
						<th>Baby2 - Citogenetic study</th>
						<th>Baby3 - Viability</th>
						<th>Baby3 - Weight</th>
						<th>Baby3 - Congenital abormality</th>
						<th>Baby3 - Citogenetic study</th>
						<th>Baby4 - Viability</th>
						<th>Baby4 - Weight</th>
						<th>Baby4 - Congenital abormality</th>
						<th>Baby4 - Citogenetic study</th>
						<th>Complications (Hemorrhaege)</th>
						<th>Complications (Infection)</th>
						<th>Complications (Other - Specify)</th>
                    </tr>
                </thead>
                <tbody>
            ");
            while ($rec = $rRec->fetch(PDO::FETCH_ASSOC)) {
                ...
                if ($rec['p_od'] <> '') {
                    $procedimiento="OD";
                    $procinmater="OD FRESCO";
                }
                if ($rec['p_cri'] >= 1) {
                    if (empty($procedimiento)) {
                        $procedimiento="FP";
                        $procinmater="CRIO ÓVULOS";
                    } else {
                        $procedimiento.="<br>FP";
                        $procinmater.="<br>CRIO ÓVULOS";
                    }
                }
                ...
                if ($rec['des_don'] == null and $rec['des_dia'] === 0) {
                    if (empty($procedimiento)) {
                        $procedimiento="FTO";
                        $procinmater="DESCONGELACION OVULOS PROPIOS";
                    } else {
                        $procedimiento.="<br>FTO";
                        $procinmater.="<br>DESCONGELACION OVULOS PROPIOS";
                    }
                }
                if ($rec['des_don'] <> null and $rec['des_dia'] === 0) {
                    if (empty($procedimiento)) {
                        $procedimiento="FTO";
                        $procinmater="DESCONGELACION OVULOS DONADOS";
                    } else {
                        $procedimiento.="<br>FTO";
                        $procinmater.="<br>DESCONGELACION OVULOS DONADOS";
                    }
                }
                //
                if (empty($rec["peso"])) {
