...
<?php
    if ($_SESSION['role'] == "9") {
        ...
        $rPaci = $db->prepare("
            ...
            where hc_reprod.estado = true and hc_reprod.p_fiv >= 1 and hc_reprod.p_icsi >= 1
        ...
        <div class="ui-content" role="main" id="imprime">
            ...
            <div class="scroll_h">
                <table style="border: 1px solid;" cellpadding="5">
                    ...
                    <?php
                        print '
                        <tr><td>FIV, ICSI</td><td>'.$ambos.'</td></tr>';
                    ?>
                        <tr>
                            <td colspan="2" bgcolor="#ffe4c4"><?php print("Total de Reproducciones:".$ambos); ?></td>
                        </tr>
                    </tbody>
                </table><br/><br/>
            </div>
