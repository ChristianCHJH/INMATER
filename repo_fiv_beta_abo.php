...
<body>
    <div data-role="page" class="ui-responsive-panel">
        <div data-role="header"><a href="javascript:window.close();" class="ui-btn-right ui-btn ui-btn-inline ui-mini ui-corner-all ui-btn-icon-right ui-icon-power" rel="external">Cerrar</a>
            <h1>Betas FIV Aborto</h1>
...
<?php
    if ($login == 'adminlab') {
        ...
        $rPaci = $db->prepare("
            ...
            , count( case when lab_aspira_t.beta = 4 then true end ) betaabo
            from hc_reprod
            ...
            , lab_aspira.tip, hc_reprod.p_cic, hc_reprod.p_fiv, hc_reprod.p_icsi, hc_reprod.p_od, hc_reprod.p_don, hc_reprod.p_cri, hc_reprod.p_iiu
            , lab_aspira.fec
            having count( case when lab_aspira_t.beta = 4 then true end ) > 0
        ...
        while ($paci = $rPaci->fetch(PDO::FETCH_ASSOC)) {
            ...
            print("
                <td>".$paci["med"]."</td>
                <td>".$paci["fec"]."</td>
                <td><a href='le_aspi1.php?id=".$paci['pro']."' target='_blank'>".$paci["betaabo"]."</a></td></tr>");
        }
        print("
            </tbody>
        </table>");
        ...
        <div class="ui-content" role="main" id="imprime">
            ...
            <div class="scroll_h">
                <table style="border: 1px solid;" cellpadding="5">
                    <tbody>
                    <?php
                        print '<tr><td>Betas FIV Aborto</td><td>'.$betaabo.'</td></tr>';
                    ?>
                        <tr>
                            <td colspan="2" bgcolor="#ffe4c4"><?php print("Total:".($betaabo) ); ?></td>
                        </tr>
                    </tbody>
                </table><br/><br/>
            </div>
