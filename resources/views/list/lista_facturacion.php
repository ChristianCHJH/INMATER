...
<body>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 input-group-sm">
                                <div class="input-group-prepend">
                                    ...
                                    <input name="ini" type="date" class="form-control form-control-sm" id="ini"
                                        value="<?php if(isset($_POST['ini'])){echo $_POST['ini'];}?>" data-mini="true">
                                    <span class="input-group-text">hasta</span>
                                    <input name="fin" type="date" class="form-control form-control-sm" id="fin"
                                        value="<?php if(isset($_POST['fin'])){echo $_POST['fin'];}?>" data-mini="true">
                                </div>
                            </div>
                        ...
                        <div class="row pb-2">
                            <div class="col-12 col-sm-12 col-md-2 col-lg-2 input-group-sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Id Recibo</span>
                        ...
                        <table class="table table-responsive table-bordered align-middle table-sm Datos" id="myTable">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th class="text-center" style="min-width: 100px;">Id Recibo</th>
    ...
    <script src="js/lista_facturacion.js?v=3" crossorigin="anonymous"></script>
