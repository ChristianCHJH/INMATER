...
<body>
    <div class='container'>
        <div data-role="header">
            ...
            <h2>Reporte NGS - Embriones Anormales</h2>
        </div>
...
<?php
    if ($_SESSION['role'] == "9") {
        ...
        $rPaci = $db->prepare("SELECT
            ...
            inner join lab_aspira_dias on lab_aspira_dias.pro = lab_aspira.pro and lab_aspira_dias.estado is true and lab_aspira_dias.ngs1 in (2) and ((lab_aspira_dias.d5d_bio<>0 and lab_aspira_dias.d5f_cic='C') or (lab_aspira_dias.d6d_bio<>0 and lab_aspira_dias.d6f_cic='C'))
        ...
        while ($paci = $rPaci->fetch(PDO::FETCH_ASSOC)) {
            ...
            print("
                ...
                <td>".$paci["fec"]."</td>
                <!--<td>".$paci["total"]."</td>-->
                <td class='text-center'>".$paci["anormal"]."</td></tr>");
        }
        print("
            </tbody>
        </table>");
?>
        <div class="ui-content" role="main" id="imprime">
            <div style="float:right">
                <?php print("<p><b>Total Embriones:</b> ".$anormal."</p>"); ?>
