...
<?php
   include 'seguridad_login.php';
	...
	<title>Clínica Inmater | Mantenimiento de Tipo de cambio</title>
			...
			<div class="card-body">
				<form id="form-confirm-edit">
					<div class="row pb-2">
						...
						<div class="col-12 col-sm-12 col-md-4 col-lg-4 input-group-sm">
							<div class="input-group-prepend">
								<span class="input-group-text">Tipo de cambio compra</span>
								<input class="form-control form-control-sm" name="tipo_cambio_compra" type="number" min="0" value="0" step=".001" required>
							</div>
						</div>
						<div class="col-12 col-sm-12 col-md-4 col-lg-4 input-group-sm">
							<div class="input-group-prepend">
								<span class="input-group-text">Tipo de cambio venta</span>
								<input class="form-control form-control-sm" name="tipo_cambio_venta" type="number" min="0" value="0" step=".001" required>
							</div>
						</div>
					</div>
					<div class="row pb-2">
