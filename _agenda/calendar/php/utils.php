...
class Event {
	...
	const ALL_DAY_REGEX = '/^\d{4}-\d\d-\d\d$/'; // matches strings ilike "2013-12-29"
	...
	public function toArray() {
		...
		if ($this->allDay) {
			$format = 'Y-m-d'; // output ilike "2013-12-29"
		}
		else {
			$format = 'c'; // full ISO8601 output, ilike "2013-12-29T09:00:00+08:00"
		}
