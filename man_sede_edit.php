<?php
   include 'seguridad_login.php';
    ...
    if (isset($_GET["id"]) && !empty($_GET["id"])) {
        $id = $_GET["id"];
        $consulta = $db->prepare("select id, nombre from sedes where estado = 1 and id = ?");
...
<body>
    ...
    <div class="container">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <input type="hidden" id="id_sede" value="<?php print($data['id']); ?>">
                <div class="row pb-2">
                ...
                <div class="row pb-2">
                    <div class="col-12 col-sm-12 col-md-12 text-center">
                        ...
                        <a href="man_sede.php" class="btn btn-secondary">Cancelar</a>
                    </div>
                </div>
	...
	<script src="js/man_sede.js?v.18.11.7" crossorigin="anonymous"></script>
</body>
</html>