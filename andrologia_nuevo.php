...
<?php
    ...
    if (isset($_POST['idx'])) {
        updateReproAndro($_POST['idx'],isset($_POST['p_dni_het']) ? $_POST['p_dni_het'] : '');
    }
...
<body>
    <div style="justify-content: center; display:flex; padding-top: 2em;">
        <form action="" method="post" data-ajax="false" id="form1" name="form1" style="width: 75%;">
            <input type="hidden" name="idx" value="<?php echo $repro['id']; ?>">

            <div style="border: 2px solid #72a2aa ;border-radius: 12px; margin-top: 0px;margin-bottom: 0px; padding-bottom: 15px;">
                <h3 style="padding: 10px; background-color: #d7e5e5; margin: 0 0 20px 0;">Andrología <?php if(isset($t_mue))print($t_mue); ?></h3>
                <?php
