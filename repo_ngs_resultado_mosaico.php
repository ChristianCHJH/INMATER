...
<body>
    <div class='container'>
        <div data-role="header">
            ...
            <h2>Reporte NGS - Embriones Mosaico</h2>
        </div>
...
<?php
    if ($_SESSION['role'] == "9") {
        ...
        $rPaci = $db->prepare("SELECT
            ...
            from hc_reprod
            inner join lab_aspira on lab_aspira.rep = hc_reprod.id and lab_aspira.estado is true and lab_aspira.f_fin is not null and lab_aspira.tip <> 'T' AND lab_aspira.dias>=5
            inner join lab_aspira_dias on lab_aspira_dias.pro = lab_aspira.pro and lab_aspira_dias.estado is true and lab_aspira_dias.ngs1 in (4) and ((lab_aspira_dias.d5d_bio<>0 and lab_aspira_dias.d5f_cic='C') or (lab_aspira_dias.d6d_bio<>0 and lab_aspira_dias.d6f_cic='C'))
...
?>
        <div class="ui-content" role="main" id="imprime">
            <div style="float:right">
                <?php print("<p><b>Total Embriones:</b> ".$mosaico."</p>"); ?>
