...
if (isSet($_POST['n_ovo']) and $_POST['guardar'] == "GUARDAR DATOS") {
    ...
    if ($_POST['Tra'] == 1)
        lab_updateAspi_sta_T($_POST['Tra_id'], $_POST['pro'], 2, $_POST['T_t_cat'], $_POST['T_s_gui'], $_POST['T_s_cat'], $_POST['T_endo'], $_POST['T_inte'], $_POST['T_eco'], $_POST['T_med'], $_POST['T_emb'], $_POST['T_obs'], $login);
    if ($cancela == $c2) {
        if ($_POST['dias'] > 3)
            lab_updateAspi_sta($_POST['pro'], 'Dia 3', 3, $_POST['hra2'], $_POST['emb2'], $_POST['hra2c'], $_POST['emb2c']);
        ...
        <div data-role="page" class="ui-responsive-panel" id="le_aspi2">
            ...
            <div data-role="header" data-position="fixed">
                ...
                <h2><?php if ($paci['tip'] == 'T') echo "(" . $paci['pro'] . ")"; else echo "(" . $paci['tip'] . "-" . $paci['pro'] . "-" . $paci['vec'] . ")";
                    echo " Dia 2"; if ($paci['fec2'] <> '1899-12-30') echo ': <small>'.date("d-m-Y", strtotime($paci['fec2'])).'</small>'; ?>
                </h2>
                            ...
                            <td width="7%">Embriologo
                                <select name="emb2" required id="emb2" data-mini="true">
                                    ...
                                    <option value=<?php echo $embrio['id'];
                                        if ($paci['emb2'] == $embrio['id']) echo " selected"; ?>>
                                        <?php echo $embrio['nom']; ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                            <td width="12%">Hora
                                <input name="hra2" type="time" data-mini="true" required id="hra2" value="<?php if ($paci['hra2'] <> "") echo $paci['hra2']; else echo date("H:i"); ?>">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="15%" class="no_traslado">
                                ...
                                <textarea name="p_notas" readonly id="p_notas" data-mini="true"><?php echo $paci['pago_notas']; ?></textarea>
                            </td>
                            <td width="10%">
                                <p>OBSERVACIONES:</p>
                            </td>
                            ...
                            <td width="5%">
                                ...
                                <select name="emb2c" id="emb2c" data-mini="true">
                                    ...
                                    <?php foreach ($rows as $embrio) { ?>
                                    <option value=<?php echo $embrio['id'];
                                        if ($paci['emb2c'] == $embrio['id']) echo " selected"; ?>>
                                        <?php echo $embrio['nom']; ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                            <td width="10%" class="peke">
                                Hora Crio
                                <input name="hra2c" type="time" data-mini="true" id="hra2c" value="<?php if ($paci['hra2c'] <> "") echo $paci['hra2c']; else echo date("H:i"); ?>">
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <tr>
                            ...
                            <td width="4%">Medico
                                <select name="T_med" id="T_med" data-mini="true">
                                    ...
                                    <option value="<?php echo $med['userx']; ?>" <?php if ($tra['med'] == $med['userx']) {echo "selected";} ?>>
                ...
                <div class="scroll_h">
                    <table data-role="table" style="margin: 0 auto;font-size:small;" class="ui-responsive table-stroke">
                        ...
                        <tr <?php if ($aspi['anu'] > 0) {
                            ...
                            <td><input type="hidden" name="anu<?php echo $c; ?>" value="<?php echo $aspi['anu']; ?>"><?php echo $aspi['ovo']; ?>
                            <td>
                                <select name="cel<?php echo $c; ?>" id="cel" data-mini="true">
                                    <?php
                                                $consulta = $db->prepare("SELECT
                                                    c.codigo, c.nombre, COALESCE(p2.id, 0) pred
                                                    FROM lab_celulas c
                                                    LEFT JOIN lab_celulas p2 ON p2.id = c.id AND p2.dia2predeterminado = 1 AND p2.estado = 1
                                                    WHERE c.estado=1 AND c.dia2=1
                                                    ORDER BY pred DESC, c.id ASC");
                                                $consulta->execute();
                                                $data = $consulta->fetchAll();
                                                foreach ($data as $item) { ?>
                                    <option value="<?php print($item['codigo']); ?>" <?php if ($aspi['d2cel'] == $item['codigo']) print(" selected"); ?>>
                            ...
                            <td><select name="sim<?php echo $c; ?>" id="sim" data-mini="true">
                                    <option value=1 <?php if ($aspi['d2sim'] == 1 or $aspi['d2sim'] == "") echo "selected"; ?>>1</option>
                            ...
                            <td class="enlinea">
                                ...
                                <select name="f_cic<?php echo $c; ?>" class="f_cic" title="<?php echo $aspi['ovo']; ?>" id="<?php echo $c; ?>" data-mini="true">
                            ...
                            <td>
                                <a href="#f<?php echo $c; ?>" data-rel="popup" data-transition="pop" id="li<?php echo $c; ?>">Detalles
