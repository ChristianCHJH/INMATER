...
<body>
    <div data-role="page" class="ui-responsive-panel">
        <div data-role="header">
            ...
            <h1>Óvulos Blastulación BHI - Día 6</h1>
            <a href="index.php"
    ...
    if ($_SESSION['role'] == "9") {
        ...
        while ($paci = $rPaci->fetch(PDO::FETCH_ASSOC)) {
            ...
            print("
                <td>".$paci["med"]."</td>
                <td>".$paci["fec"]."</td>
                <td><a href='le_aspi6.php?id=".$paci['pro']."' target='_blank'>".$paci["blasinid6"]."</a></td></tr>");
        }
        print("
            </tbody>
        </table>");
    ...
    <div class="ui-content" role="main" id="imprime">
        ...
        <div class="scroll_h">
            <table style="border: 1px solid;" cellpadding="5">
                <tbody>
                <?php
                    print '<tr><td>Blastulación BHI</td><td>'.$blasinid6.'</td></tr>';
                ?>
                    <tr>
                        <td colspan="2" bgcolor="#ffe4c4"><?php print("Total:".($blasinid6) ); ?></td>
                    </tr>
                </tbody>
            </table><br/><br/>
        </div>
