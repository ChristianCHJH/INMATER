	...
	function load_item(id) {
		...
		$.ajax({
			...
			success: function (response) {
				...
				document.getElementById("form-confirm-edit").elements["tipo_cambio_compra"].value = data.tipo_cambio_compra;
				document.getElementById("form-confirm-edit").elements["tipo_cambio_venta"].value = data.tipo_cambio_venta;
			},
			error: function (jqXHR, exception) {
				console.log(jqXHR, exception);
			},
