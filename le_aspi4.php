...
if (isset($_POST['n_ovo']) and $_POST['guardar'] == "GUARDAR DATOS") {
    ...
    if ($_POST['Tra'] == 1)
        lab_updateAspi_sta_T($_POST['Tra_id'], $_POST['pro'], 4, $_POST['T_t_cat'], $_POST['T_s_gui'], $_POST['T_s_cat'], $_POST['T_endo'], $_POST['T_inte'], $_POST['T_eco'], $_POST['T_med'], $_POST['T_emb'], $_POST['T_obs'], $login);
        ...
        <div data-role="page" class="ui-responsive-panel" id="le_aspi4">
            ...
            <div data-role="header" data-position="fixed">
                ...
                <h2><?php if ($paci['tip'] == 'T') echo "(" . $paci['pro'] . ")"; else echo "(" . $paci['tip'] . "-" . $paci['pro'] . "-" . $paci['vec'] . ")";
                    echo " Dia 4"; if ($paci['fec4'] <> '1899-12-30') echo ': <small>'.date("d-m-Y", strtotime($paci['fec4'])).'</small>'; ?>
                </h2>
                <a href="salir.php"
                            ...
                            <td width="7%">Embriologo
                                <select name="emb4" required id="emb4" data-mini="true">
                                    ...
                                    <option value=<?php echo $embrio['id'];
                                        if ($paci['emb4'] == $embrio['id']) echo " selected"; ?>>
                        ...
                        <tr>
                            ...
                            <td width="5%">
                                ...
                                <select name="emb4c" id="emb4c" data-mini="true">
                                    ...
                                    <?php foreach ($rows as $embrio) { ?>
                                    <option value=<?php echo $embrio['id'];
                                        if ($paci['emb4c'] == $embrio['id']) echo " selected"; ?>>
                                        <?php echo $embrio['nom']; ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                    ...
                    <table data-role="table" style="margin: 0 auto;font-size:small;" class="ui-responsive table-stroke">
                        ...
                        <tr <?php if ($aspi['anu'] > 0) {
                                ...
                                <select name="cel<?php echo $c; ?>" class="val_defect" title="<?php echo $c; ?>"
                                    ...
                                    <?php
                                                $consulta = $db->prepare("SELECT
                                                    c.codigo, c.nombre, COALESCE(p4.id, 0) pred
                                                    FROM lab_celulas c
                                                    LEFT JOIN lab_celulas p4 ON p4.id = c.id AND p4.dia4predeterminado = 1 AND p4.estado = 1
                                                    WHERE c.estado=1 AND c.dia4=1
                                                    ORDER BY pred DESC, c.id ASC");
                                                $consulta->execute();
                                                $data = $consulta->fetchAll();
                                                foreach ($data as $item) { ?>
                                    <option value="<?php print($item['codigo']); ?>"
                                        <?php if ($aspi['d4cel'] == $item['codigo']) print(" selected"); ?>>
                            ...
                            <td><select name="mci<?php echo $c; ?>" id="mci<?php echo $c; ?>" data-mini="true">
                                    <option value="" selected>Seleccionar</option>
                                    <option value="a" <?php if ($aspi['d4mci'] == "a") {echo "selected";} ?>>a</option>
                                    <option value="b" <?php if ($aspi['d4mci'] == "b") {echo "selected";} ?>>b</option>
                                    <option value="c" <?php if ($aspi['d4mci'] == "c") {echo "selected";} ?>>c</option>
                                    <option value="d" <?php if ($aspi['d4mci'] == "d") {echo "selected";} ?>>d</option>
                            ...
                            <td>
                                <select name="tro<?php echo $c; ?>" id="tro<?php echo $c; ?>" data-mini="true">
                                    <option value="" selected>Seleccionar</option>
                                    <option value="a" <?php if ($aspi['d4tro'] == "a") {echo "selected";} ?>>a</option>
                                    <option value="b" <?php if ($aspi['d4tro'] == "b") {echo "selected";} ?>>b</option>
                                    <option value="c" <?php if ($aspi['d4tro'] == "c") {echo "selected";} ?>>c</option>
                                    <option value="d" <?php if ($aspi['d4tro'] == "d") {echo "selected";} ?>>d</option>
                                </select>
                            </td>
                            <td class="enlinea">
                                <script>
                                ...
                                <select name="f_cic<?php echo $c; ?>" class="f_cic" title="<?php echo $aspi['ovo']; ?>"
                                    ...
                                    <option value="O"
                                        <?php if ($aspi['d4f_cic'] == "O" || $aspi['anu'] == 0 || $aspi['d4f_cic'] == "") {echo "selected";} ?>>
                                        Obs</option>
                                </select>
