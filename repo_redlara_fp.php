    ...
    <div class='container'>
        ...
        if ($_SESSION['role'] == 2) {
            ...
            $rRec = $db->prepare("
                ...
                , lab_aspira.n_ovo
                , count( case when lab_aspira_dias.d0est = 'MII' then true end ) vitris
            ...
            <table class='table table-responsive table-bordered align-middle header-fixed' id='repo_model_01'>
                <thead class='thead-dark'>
                    <tr>
                        ...
                        <th>Number of oocytes cryopreserved</th>
            ...
            while ($rec = $rRec->fetch(PDO::FETCH_ASSOC)) {
                ...
                <tr>
            		...
            		<td>".$rec["peso"]."</td>
                    <td>".$rec["talla"]."</td>
                    <td>other condition/diseases pottentially affecting ovarian reserve</td>
                    <td>antagonist</td>
                    <td>not available</td>
                    <td>not available</td>
                    <td>not available</td>
