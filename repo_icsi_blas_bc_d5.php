...
<body>
    <div data-role="page" class="ui-responsive-panel">
        <div data-role="header">
            ...
            <h1>Óvulos Blastulación BC - Día 5</h1>
            <a href="index.php"
    ...
    if ($_SESSION['role'] == "9") {
        ...
        while ($paci = $rPaci->fetch(PDO::FETCH_ASSOC)) {
            ...
            print("
                <td>".$paci["med"]."</td>
                <td>".$paci["fec"]."</td>
                <td><a href='le_aspi5.php?id=".$paci['pro']."' target='_blank'>".$paci["blascavid5"]."</a></td></tr>");
        }
        print("
            </tbody>
        </table>");
    ...
    <div class="ui-content" role="main" id="imprime">
        ...
        <div class="scroll_h">
            <table style="border: 1px solid;" cellpadding="5">
                <tbody>
                <?php
                    print '<tr><td>Blastulación BC</td><td>'.$blascavid5.'</td></tr>';
                ?>
                    <tr>
                        <td colspan="2" bgcolor="#ffe4c4"><?php print("Total:".($blascavid5) ); ?></td>
                    </tr>
                </tbody>
            </table><br/><br/>
        </div>
