...
<body>
    <div class='container'>
        <div data-role="header">
            ...
            <h2>Reporte NGS - Embriones NR</h2>
        </div>
...
<?php
    if ($_SESSION['role'] == "9") {
        ...
        $rPaci = $db->prepare("SELECT
            ...
            inner join lab_aspira_dias on lab_aspira_dias.pro = lab_aspira.pro and lab_aspira_dias.estado is true and lab_aspira_dias.ngs1 in (3) and ((lab_aspira_dias.d5d_bio<>0 and lab_aspira_dias.d5f_cic='C') or (lab_aspira_dias.d6d_bio<>0 and lab_aspira_dias.d6f_cic='C'))
        ...
        <table class='table table-responsive table-bordered align-middle'>
            <thead class='thead-dark'>
                <tr>
                    ...
                    <th class='text-center'>Embriones<br>NR</th>
                </tr>
            </thead>
            <tbody>
        ");
        while ($paci = $rPaci->fetch(PDO::FETCH_ASSOC)) {
            ...
            print("
                ...
                <td>".$paci["fec"]."</td>
                <!--<td>".$paci["total"]."</td>-->
                <td class='text-center'>".$paci["nr"]."</td></tr>");
        }
        print("
            </tbody>
        </table>");
?>
        <div class="ui-content" role="main" id="imprime">
            <div style="float:right">
                <?php print("<p><b>Total Embriones:</b> ".$nr."</p>"); ?>
                <p>
                    <b>Fecha y Hora de Reporte:</b>
                    <?php
