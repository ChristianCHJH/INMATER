<?php
    ...
    if (isset($_GET["id"]) && !empty($_GET["id"])) {
        $id = $_GET["id"];
        $consulta = $db->prepare("select id, nombre from man_extras_medico where estado = 1 and id = ?");
...
<body>
    ...
    <div class="container">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <input type="hidden" id="id_man_extras_medico" value="<?php print($data['id']); ?>">
                <div class="row pb-2">
                ...
                <div class="row pb-2">
                    <div class="col-12 col-sm-12 col-md-12 text-center">
                        ...
                        <a href="man_extras_medico.php" class="btn btn-secondary">Cancelar</a>
                    </div>
                </div>
	...
	<script src="js/man_extras_medico.js?v.18.11.7" crossorigin="anonymous"></script>
</body>
</html>