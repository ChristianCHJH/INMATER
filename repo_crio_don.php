...
$rPaci = $db->prepare("
    ...
    inner join lab_aspira on lab_aspira.rep = hc_reprod.id and lab_aspira.estado is true and lab_aspira.f_fin is not null and lab_aspira.tip='D' and lab_aspira.tip <> 'T'$between
